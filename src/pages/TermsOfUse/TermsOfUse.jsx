...
export default function TermsOfUse() {
    return (
        <Box className='flex flex-col w-full h-full items-center pt-6'>
            <Box className="flex flex-col w-3/4 items-center space-y-5">
                <Typography className="flex w-fit" fontSize={24} fontWeight='bold'>Пользовательское Соглашение</Typography>
                <Typography>
                    Настоящее Пользовательское Соглашение (Далее Соглашение) регулирует отношения между владельцем miomi.by (далее MioMi или Администрация) с одной стороны и пользователем сайта с другой.
                    Сайт MioMi является средством массовой информации.
                </Typography>
                <Typography textAlign='left' className='w-full pb-12'>
                    Используя сайт, Вы соглашаетесь с условиями данного соглашения.
                    <p className="font-bold">Если Вы не согласны с условиями данного соглашения, не используйте сайт MioMi!</p>
                </Typography>
                <Typography textAlign='left' className="w-full pb-12">
                    <p className="font-bold text-base">Предмет соглашения</p>
                    <p className="font-bold">Администрация предоставляет пользователю право на размещение на сайте следующей информации:</p>
                ...
                <Typography textAlign='left' className='w-full pb-12'>
                    ...
                    <p>- в случае возникновения форс-мажорной ситуации (боевые действия, чрезвычайное положение, стихийное бедствие и т. д.)</p>
                    <p>Администрация не гарантирует сохранность информации, размещённой Пользователем, а также бесперебойную работу информационного ресурса</p>
                    </Typography>
